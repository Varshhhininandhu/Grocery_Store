...
setData((pre)=>({...pre,[name]:value}))
  ...
  alert ("Ohh! you are not providing complete data")
    ...
    return <div>
       ...
       <h1 style={{textAlign:"center" ,fontSize:"20px" ,color:"black",marginTop:"30px"}}>Update Your Products</h1>
       <Box>
    <Box ml='575px'maxW='sm' borderWidth='1px' borderRadius='lg' padding={'20px'} backgroundColor='orange.200' >
    <Center>
...
{ourdata===false?<Button   width="150px" mt="30px" bg="#8BC34A" marginLeft="80px" textAlign="center" type="submti">
