import { Card, CardBody, CardFooter, Button, Divider, Text, Heading, ButtonGroup, Stack, Image, Flex, useToast } from '@chakra-ui/react';
    ...
    <Card maxW='sm'>
      <CardBody>
        <RouterLink to={`/singleProductPage/${id}`}>
          <Image src={image} minH={'250px'} alt='Not Available' borderRadius='lg' />
        </RouterLink>
